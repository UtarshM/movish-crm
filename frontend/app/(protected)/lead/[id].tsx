  ...
  const openWhatsApp = async () => {
    if (lead?.phone) {
      try {
        ...
        const msg = `Hello ${lead.name || 'Customer'},\nThank you for connecting with Movish Auto. We have updated your details for commercial vehicle ${lead.vehicleNo || lead.vehicle_number || ''}. Please let us know a convenient time to speak!\nRegards,\nMovish Auto CRM`;
