...
export default function DashboardScreen() {
  ...
  const modules = [
    ...
    { name: 'Vehicle Services', icon: 'construct', color: '#084D8C', route: '/(protected)/services' },
    { name: 'Workshop Tickets', icon: 'document-text', color: '#f59e0b', route: '/(protected)/claims' },
    ...
    { name: 'Finance & Loans', icon: 'cash', color: '#84cc16', route: '/(protected)/loans' },
      ...
      >
        ...
        <View style={styles.statsSection}>
          <View style={styles.statsGrid}>
            ...
            <StatCard icon="shield-checkmark" value={stats.claims} label="Workshop" color="#ef4444" />
          </View>
        </View>
