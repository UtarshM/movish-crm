  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Finance & Loans</Text>
      ...
      <FlatList data={items} keyExtractor={i => i.id} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor={Colors.primary} />}
        ...
        ListEmptyComponent={<View style={styles.empty}><Ionicons name="cash-outline" size={48} color={Colors.textLight} /><Text style={styles.emptyText}>No finance records found</Text></View>}
        renderItem={({ item }) => {
