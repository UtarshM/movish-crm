...
import { View, Text, TextInput, Pressable, StyleSheet, KeyboardAvoidingView, Platform, ActivityIndicator, SafeAreaView, Alert, Image } from 'react-native';
    ...
    <SafeAreaView style={styles.safeArea}>
      <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Movish Auto CRM</Text>
          <Text style={styles.subtitle}>Commercial Vehicle Dealership Portal</Text>
        </View>
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.footerCred}>admin@movish.com / Admin@123</Text>
        </View>
